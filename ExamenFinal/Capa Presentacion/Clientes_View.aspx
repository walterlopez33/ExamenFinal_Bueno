...
<div class="container d-flex align-items-center flex-column">
    ...
    <asp:GridView ID="listaDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SQLClientes" CellPadding="4" ForeColor="#333333" GridLines="None">
